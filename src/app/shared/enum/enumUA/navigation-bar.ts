export enum NavBarName {
  ...
  Drafts = 'ENUM.NAV_BAR_NAME.MY_DRAFTS',
  ...
  CreateSubject = 'ENUM.NAV_BAR_NAME.ADD_SUBJECTS',
  EditSubject = 'ENUM.NAV_BAR_NAME.EDIT_SUBJECTS',
  ...
  EditCompetitionDraft = 'ENUM.NAV_BAR_NAME.EDIT_COMPETITION_DRAFT',
  ...
  CompetitionDrafts = 'ENUM.NAV_BAR_NAME.COMPETITION_DRAFTS'
}
