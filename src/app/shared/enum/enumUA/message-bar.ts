...
export enum SnackbarText {
  ...
  archiveWorkshop = 'SERVICE_MESSAGES.SNACK_BAR_TEXT.ARCHIVE_WORKSHOP',
  ...
  createCompetition = 'SERVICE_MESSAGES.SNACK_BAR_TEXT.CREATE_COMPETITION',
  updateCompetition = 'SERVICE_MESSAGES.SNACK_BAR_TEXT.UPDATE_COMPETITION',
  deleteCompetition = 'SERVICE_MESSAGES.SNACK_BAR_TEXT.DELETE_COMPETITION',
  archiveCompetition = 'SERVICE_MESSAGES.SNACK_BAR_TEXT.ARCHIVE_COMPETITION',
  ...
  createSubjectSuccess = 'SERVICE_MESSAGES.SNACK_BAR_TEXT.CREATE_SUBJECT',
  updateStudySubject = 'SERVICE_MESSAGES.SNACK_BAR_TEXT.UPDATE_SUBJECT',
  deleteStudySubject = 'SERVICE_MESSAGES.SNACK_BAR_TEXT.DELETE_SUBJECT',
  ...
  errorDefaultTeacher = 'SERVICE_MESSAGES.SNACK_BAR_TEXT.ERROR_DEFAULT_TEACHER',

  createPositionSuccess = 'SERVICE_MESSAGES.SNACK_BAR_TEXT.POSITION_CREATED_SUCCESS',
  updatePositionSuccess = 'SERVICE_MESSAGES.SNACK_BAR_TEXT.POSITION_UPDATED_SUCCESS',
  deletePositionSuccess = 'SERVICE_MESSAGES.SNACK_BAR_TEXT.POSITION_DELETED_SUCCESS',
  positionByTitleNotFound = 'SERVICE_MESSAGES.SNACK_BAR_TEXT.POSITION_BY_TITLE_NOT_FOUND',
  positionByIdNotFound = 'SERVICE_MESSAGES.SNACK_BAR_TEXT.POSITION_NOT_FOUND',
  getDraftFail = 'SERVICE_MESSAGES.SNACK_BAR_TEXT.GET_DRAFT_FAIL',
  getTimeToLiveFail = 'SERVICE_MESSAGES.SNACK_BAR_TEXT.GET_TIME_TO_LIVE_FAIL',
  deleteDraftFail = 'SERVICE_MESSAGES.SNACK_BAR_TEXT.DELETE_DRAFT_FAIL',
  deleteDraftSuccess = 'SERVICE_MESSAGES.SNACK_BAR_TEXT.DELETE_DRAFT_SUCCESS',
