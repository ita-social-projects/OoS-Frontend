export enum ApplicationTitles {
  ...
  Studying = 'Навчається 1-11 років',
  Approved = 'Зараховано',
  Rejected = 'Відмовлено',
...
export enum ApplicationTitlesReverse {
  ...
  'Навчається 1-11 років' = 'Studying',
  'Зараховано' = 'Approved',
  'Відмовлено' = 'Rejected',
  'Гурток залишено' = 'Left',
   'Користувач завершив навчання' = 'Finished',
...
export enum ApplicationStatusDescription {
  ...
  Studying = 'Користувач навчається в школі/гуртку 1 рік, 2 роки і т.д. і продовжує начатися',
  Rejected = 'Користувачеві відмовлено у зарахуванні з причиною',
  Left = 'Користувач покинув гурток самостійно',
  Finished = 'Користувач завершив навчання',
