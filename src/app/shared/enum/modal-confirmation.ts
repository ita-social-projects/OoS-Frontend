...
export enum ModalConfirmationTitle {
  ...
  blockProviderAdmin = 'ЗАБЛОКУВАТИ АДМІНІСТРАТОРА ГУРТКА?',
  blockProviderAdminDeputy = 'ЗАБЛОКУВАТИ ЗАСТУПНИКА ДИРЕКТОРА?',
  blockProvider = 'ЗАБЛОКУВАТИ НАДАВАЧА ПОСЛУГ?',
  unBlockProvider= 'РОЗБЛОКУВАТИ НАДАВАЧА ПОСЛУГ?',
  ...
  blockMinistryAdmin = 'ЗАБЛОКУВАТИ АДМІНІСТРАТОРА МІНІСТЕРСТВА?',
  ...
  licenseApproved = 'ПІДТВЕРДИТИ ЛІЦЕНЗІЮ ЗАКЛАДУ?',
}
...
export enum ModalConfirmationText {
  ...
  blockProviderAdmin = 'Ви впевнені, що хочете заблокувати адміністратора гуртка?',
  blockProviderAdminDeputy = 'Ви впевнені, що хочете заблокувати заступника директора?',
  blockProvider = 'Ви впевнені, що хочете заблокувати надавача послуг?',
  unBlockProvider= 'Ви впевнені, що хочете розблокувати надавача послуг?',
  ...
  licenseApproved = "Ви впевнені, що хочете підтвердити ліцензію закладу?",
}
