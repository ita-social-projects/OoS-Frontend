...
describe('ImportProvidersComponent', () => {
  ...
  it('should return true and cut the array when more than 100 providers', () => {
    ...
    const result = component.showsIsTrimmed(providersData);
  ...
  // filterInvalidProviders() method tests
  ...
  // checkHeadersIsValid() method tests
  ...
  // processProvidersData() method test
  it('should process providers data and handle emails EDRPOUs', (done) => {
    ...
    jest.spyOn(component, 'showsIsTrimmed').mockReturnValue(true);
    ...
    expect(component.showsIsTrimmed).toHaveBeenCalledWith(inputProviders);
  ...
  // verifyEmailsEdrpous() method test
